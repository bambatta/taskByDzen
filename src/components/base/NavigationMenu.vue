<template>
    <aside class="aside">
        <div class="aside__conetent">
            <div class="aside__profile">
                <img src="/img/avatar.jpeg" alt="avatar" class="aside__profile-img">
                <button class="aside__profile-setup">
                    <img src="/img/gear.png" class="aside__profile-setting" alt="gear">
                </button>
            </div>
            <nav class="nav">
                <ul class="nav__list">
